...
import { HolyName } from "./holy-name"
...
export function VerseDisplay({ verse, verseNumber, isActive, activeWordIndex, fontSize = 24 }: VerseDisplayProps) {
  ...
  return (
    ...
    >
      <div className="flex gap-3 sm:gap-4">
        ...
        {/* Verse text - word by word with proper spacing */}
        <p
        ...
        >
          {words.map((word, wordIdx) => {
            ...
            // Check if word contains holy name
